...
function eixRenderExplore(body, D, verticals, horizontals, POIS){
  ...
  body.innerHTML=
    ...
    '<div class="card" id="eix-stage" style="position:relative;overflow:hidden;height:60vh;padding:0;touch-action:none">'+
  ...
  eixAttachPanZoom(svg, built.gridW, built.gridH, stage, function(ratio){
...
function eixAttachPanZoom(svg, gridW, gridH, container, onZoom){
  ...
  function apply(){ svg.setAttribute('viewBox', vx+' '+vy+' '+vw+' '+vh); if(onZoom) onZoom(vw/gridW); }
  function clamp(){
