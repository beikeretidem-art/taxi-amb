...
function eixRenderExplore(body, D, verticals, horizontals, POIS){
  ...
  POIS.forEach(function(p){
    ...
    /* si comparteix encreuament amb un altre punt, alterna una fila més avall
     * perquè els noms no es solapin entre ells */
    lbl.setAttribute('x',x+7); lbl.setAttribute('y', y+(slot%2===1? 15:3));
  ...
  body.innerHTML=
    ...
    '<div class="card" id="eix-mapcard" style="overflow:hidden;padding:0">'+
      '<div id="eix-header" style="position:relative;height:60px;border-bottom:1px solid var(--line);overflow:hidden"></div>'+
  ...
  function layoutHeader(vx0, vw0){
    ...
    verticals.forEach(function(v){
      ...
      vLabels[v.id].style.right=(headerW-px)+'px';
    });
  }
